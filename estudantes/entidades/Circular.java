...
public class Circular extends Deliberacao {
    ...
    @Override // implemntação do metodo de comparação de objetos, equals
    public boolean equals(Object obj) { 
        if (this == obj) return true; // se forem exatamente o memso objeto, retorna true e encerra o método
        if (obj == null || getClass() != obj.getClass()) return false; //se for null ou de outra classe, retorn false e encerra o método
        Circular outra = (Circular) obj; // Cnfirmando que não é o mesmo, null ou de outra classe, faz o casting para circular
